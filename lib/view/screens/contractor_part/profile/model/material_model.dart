...
class MaterialModel {
  ...
  MaterialModel({this.success, this.message, this.meta, this.materialList});
  ...
  factory MaterialModel.fromJson(Map<String, dynamic> json) => MaterialModel(
    ...
    materialList:
        json["data"] == null
            ? []
            : List<Material>.from(
              json["data"]!.map((x) => Material.fromJson(x)),
            ),
  );
...
class Material {
  ...
  Material({this.id, this.name, this.unit, this.price, this.isDeleted});
