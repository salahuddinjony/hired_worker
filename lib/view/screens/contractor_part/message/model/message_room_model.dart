...
AllMessageRoomModel allMessageRoomModelFromJson(String str) => AllMessageRoomModel.fromJson(json.decode(str));

String allMessageRoomModelToJson(AllMessageRoomModel data) => json.encode(data.toJson());
...
class AllMessageRoomModel {
    ...
    factory AllMessageRoomModel.fromJson(Map<String, dynamic> json) => AllMessageRoomModel(
