          ...
          return GridView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              ...
              return CustomServiceContractorCard(
                hourlyPrice:
                    contractorsWithSubCategory[index].rateHourly.toString(),
                image: ImageHandler.imagesHandle(
                  contractorsWithSubCategory[index].userId.img,
                ),
                name: contractorsWithSubCategory[index].userId.fullName,
                title:
                    contractorsWithSubCategory[index].skillsCategory.toString(),
