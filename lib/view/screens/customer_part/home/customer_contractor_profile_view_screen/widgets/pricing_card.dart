              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 4.h),
                    CustomText(text: "Professional Rate", fontSize: 12.w, fontWeight: FontWeight.w400, color: AppColors.black_08),
                  ],
                ),
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      SizedBox(width: 4.w),
                      CustomText(text: "Competitive", fontSize: 11.w, fontWeight: FontWeight.w500, color: Colors.green),
                    ],
                  ),
                ),
              ],
