...
class ScheduleWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children:
          scheduleModel.schedules.map<Widget>((schedule) {
            return Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Container(
                    ...
                    color: AppColors.black_08.withValues(alpha: .12),
                  ),
                  ...
                  Expanded(
                    child: Wrap(
                      ...
                      children:
                          schedule.timeSlots.map<Widget>((timeSlot) {
                            return Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                border: Border.all(
                                  color: AppColors.black_08.withValues(
                                    alpha: .06,
                                  ),
                                ),
                              ),
